...
Rails.application.config.assets.precompile += %w( style2.scss.css )
...
Rails.application.config.assets.precompile += %w( jquery.countdown.scss.css )
Rails.application.config.assets.precompile += %w( style.scss.css )
