...
Rails.application.config.assets.precompile += %w( bootstrap.min.css.scss )
Rails.application.config.assets.precompile += %w( animate.min.css.scss )
Rails.application.config.assets.precompile += %w( settings.css.scss.erb )
Rails.application.config.assets.precompile += %w( prettyPhoto.css.scss )
Rails.application.config.assets.precompile += %w( font-awesome.min.css.scss )
Rails.application.config.assets.precompile += %w( jquery.countdown.css.scss )
